import { protocol as et, app as W, ipcMain as A, dialog as q, BrowserWindow as ce, net as Mt } from "electron";
import x from "node:path";
import w from "node:fs";
import { fileURLToPath as Ae, pathToFileURL as Bt } from "node:url";
import { TextDecoder as xe } from "node:util";
...
class Ee extends tt {
  ...
  static async fromFile(e) {
    ...
    return new Ee(t, { fileInfo: { path: e, size: r.size } });
  }
  constructor(e, t) {
...
const Lt = Ee.fromFile;
function Ut(i) {
  return i && i.__esModule && Object.prototype.hasOwnProperty.call(i, "default") ? i.default : i;
}
var Te = { exports: {} }, Z = { exports: {} }, ge, Oe;
function zt() {
  if (Oe) return ge;
  Oe = 1;
  ...
  function i(e) {
    ...
    function r(u) {
      ...
      function T(...k) {
        if (!T.enabled)
          return;
        const B = T, Y = Number(/* @__PURE__ */ new Date()), Et = Y - (l || Y);
        B.diff = Et, B.prev = l, B.curr = Y, l = Y, k[0] = r.coerce(k[0]), typeof k[0] != "string" && k.unshift("%O");
        let K = 0;
        k[0] = k[0].replace(/%([a-zA-Z%])/g, (he, _t) => {
          if (he === "%%")
            return "%";
          K++;
          ...
          if (typeof Fe == "function") {
            const Rt = k[K];
            he = Fe.call(B, Rt), k.splice(K, 1), K--;
          }
          return he;
...
typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? Te.exports = Xt() : Te.exports = Gt();
var jt = Te.exports;
const $ = /* @__PURE__ */ Ut(jt), Wt = "End-Of-Stream";
...
function ii(i) {
  const e = [];
  for (let t = 0; t < i.length; t += L) {
    const r = Math.min(i.length, t + L), n = new Array(r - t);
...
function ni(i) {
  ...
  for (let r = 0; r < i.length; r++) {
    ...
    t += a ?? String.fromCharCode(n), t.length >= L && (e.push(t), t = "");
  }
  return t && e.push(t), e.join("");
}
function h(i) {
...
function pt(i, e = "utf8") {
  return _i(i), ee[e] ?? (ee[e] = new globalThis.TextDecoder(e)), ee[e].decode(i);
}
function ft(i) {
  if (typeof i != "string")
...
`, "\r", "	", " ", "\0"].some((t) => this.checkString(t, { offset: 6 })))
  ...
  async readTiffHeader(e) {
    const t = (e ? j : R).get(this.buffer, 2), r = (e ? ae : b).get(this.buffer, 4);
    if (t === 42) {
      if (r >= 6) {
...
const H = (i) => class extends Error {
  constructor(t) {
    super(t), this.name = i;
  }
};
class Ji extends H("CouldNotDetermineFileTypeError") {
}
class Qi extends H("UnsupportedFileTypeError") {
}
class er extends H("UnexpectedFileContentError") {
  constructor(e, t) {
...
class Re extends H("FieldDecodingError") {
}
class wt extends H("InternalParserError") {
}
...
function rr(i) {
  const e = i.length;
  if (e & 1)
    throw new Re("Buffer length must be even");
  for (let t = 0; t < e; t += 2) {
    const r = i[t];
    i[t] = i[t + 1], i[t + 1] = r;
  }
...
function Ie(i, e) {
  if (i[0] === 255 && i[1] === 254)
    return Ie(i.subarray(2), e);
  if (e === "utf-16le" && i[0] === 254 && i[1] === 255) {
    if (i.length & 1)
      throw new Re("Expected even number of octets for 16-bit unicode string");
    return Ie(rr(i), e);
  }
...
class Me extends V {
  static toRating(e) {
    return {
      source: e.email,
      rating: e.rating > 0 ? (e.rating - 1) / 254 * S.maxRatingScore : void 0
    };
  }
  constructor() {
  ...
  postMap(e, t) {
    switch (e.id) {
      case "UFID":
        {
          const r = e.value;
          r.owner_identifier === "http://musicbrainz.org" && (e.id += `:${r.owner_identifier}`, e.value = Ie(r.identifier, "latin1"));
        }
        break;
      case "PRIV":
        {
          ...
          switch (r.owner_identifier) {
            case "AverageLevel":
            case "PeakValue":
              e.id += `:${r.owner_identifier}`, e.value = r.data.length === 4 ? b.get(r.data, 0) : null, e.value === null && t.addWarning("Failed to parse PRIV:PeakValue");
              break;
            default:
  ...
  postMap(e) {
    switch (e.id) {
      case "WM/SharedUserRating": {
        const t = e.id.split(":");
        e.value = Be.toRating(e.value), e.id = t[0];
        break;
      }
    }
  }
...
class oe extends S {
  static toRating(e, t, r) {
    return {
      ...
      rating: Number.parseFloat(t) / r * S.maxRatingScore
    };
  }
  constructor() {
    super(["vorbis"], Ir);
...
`), t = [], r = /\[(\d{2}):(\d{2})\.(\d{2})\]/;
  ...
  return {
    contentType: ve.lyrics,
    timeStampFormat: Se.milliseconds,
    syncText: t
  };
}
const F = $("music-metadata:collector"), Br = ["matroska", "APEv2", "vorbis", "ID3v2.4", "ID3v2.3", "ID3v2.2", "exif", "asf", "iTunes", "AIFF", "ID3v1"];
class Fr {
  constructor(e) {
  ...
  addStreamInfo(e) {
    F(`streamInfo: type=${e.type ? ke[e.type] : "?"}, codec=${e.codecName}`), this.format.trackInfo.push(e);
  }
  setFormat(e, t) {
    var r;
  ...
  async postMap(e, t) {
    switch (t.id) {
      ...
      case "totaltracks":
        this.common.track.of = S.toIntOrNull(t.value);
        return;
      case "totaldiscs":
        this.common.disk.of = S.toIntOrNull(t.value);
        return;
      case "movementTotal":
        this.common.movementIndex.of = S.toIntOrNull(t.value);
        return;
      case "track":
      case "disk":
      case "movementIndex": {
        const r = this.common[t.id].of;
        this.common[t.id] = S.normalizeTrack(t.value), this.common[t.id].of = r ?? this.common[t.id].of;
        return;
      }
      case "bpm":
      case "year":
...
const Or = {
  ...
  async load(i, e, t) {
    return new (await import("./MpegParser-BWYyF4S0.js")).MpegParser(i, e, t);
  }
}, Pr = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  extensions: [".asf"],
  async load(i, e, t) {
    return new (await import("./AsfParser-iwaAKHzp.js")).AsfParser(i, e, t);
  }
}, Lr = {
  parserType: "dsdiff",
  extensions: [".dff"],
  async load(i, e, t) {
    return new (await import("./DsdiffParser-CshxO0ry.js")).DsdiffParser(i, e, t);
  }
}, Ur = {
  parserType: "aiff",
  extensions: [".aif", "aiff", "aifc"],
  async load(i, e, t) {
    return new (await import("./AiffParser-D3TOf4vp.js")).AIFFParser(i, e, t);
  }
}, zr = {
  parserType: "dsf",
  extensions: [".dsf"],
  async load(i, e, t) {
    return new (await import("./DsfParser-DECl5E49.js")).DsfParser(i, e, t);
  }
}, Xr = {
  parserType: "flac",
  extensions: [".flac"],
  async load(i, e, t) {
    return new (await import("./FlacParser-MksqzXCf.js")).FlacParser(i, e, t);
  }
}, Gr = {
  parserType: "matroska",
  extensions: [".mka", ".mkv", ".mk3d", ".mks", "webm"],
  async load(i, e, t) {
    return new (await import("./MatroskaParser-Cd4qicOs.js")).MatroskaParser(i, e, t);
  }
}, jr = {
  parserType: "mp4",
  extensions: [".mp4", ".m4a", ".m4b", ".m4pa", "m4v", "m4r", "3gp"],
  async load(i, e, t) {
    return new (await import("./MP4Parser-qpDv45U0.js")).MP4Parser(i, e, t);
  }
}, Wr = {
  parserType: "musepack",
  extensions: [".mpc"],
  async load(i, e, t) {
    return new (await import("./MusepackParser-C-PsZo7l.js")).MusepackParser(i, e, t);
  }
}, qr = {
  parserType: "ogg",
  extensions: [".ogg", ".ogv", ".oga", ".ogm", ".ogx", ".opus", ".spx"],
  async load(i, e, t) {
    return new (await import("./OggParser-CkSDUKub.js")).OggParser(i, e, t);
  }
}, $r = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  async load(i, e, t) {
    return new (await import("./WavPackParser-B4uWQaU6.js")).WavPackParser(i, e, t);
  }
}, Hr = {
  parserType: "riff",
  extensions: [".wav", "wave", ".bwf"],
  async load(i, e, t) {
    return new (await import("./WaveParser-UvKrtHN9.js")).WaveParser(i, e, t);
  }
}, O = $("music-metadata:parser:factory");
function Vr(i) {
  const e = _e.parse(i), t = Yi(e.type);
  return {
    type: t.type,
    subtype: t.subtype,
    suffix: t.suffix,
...
const Zr = /^[\x21-\x7e©][\x20-\x7e\x00()]{3}/, yt = {
  ...
  get: (i, e) => {
    ...
    if (!t.match(Zr))
      throw new Re(`FourCC contains invalid characters: ${nr(t)} "${t}"`);
    return t;
  },
  put: (i, e, t) => {
    const r = Mi(t);
...
const Ve = {
  ...
  get: (i, e) => ({
    ...
    version: b.get(i, e + 4) / 1e3,
    // the number of descriptor bytes (allows later expansion of this header)
    descriptorBytes: b.get(i, e + 8),
    // the number of header APE_HEADER bytes
    headerBytes: b.get(i, e + 12),
    // the number of header APE_HEADER bytes
    seekTableBytes: b.get(i, e + 16),
    // the number of header data bytes (from original file)
    headerDataBytes: b.get(i, e + 20),
    // the number of bytes of APE frame data
    apeFrameDataBytes: b.get(i, e + 24),
    // the high order number of APE frame data bytes
    apeFrameDataBytesHigh: b.get(i, e + 28),
    // the terminating data of the file (not including tag data)
    terminatingDataBytes: b.get(i, e + 32),
  ...
  get: (i, e) => ({
    ...
    blocksPerFrame: b.get(i, e + 4),
    // the number of audio blocks in the final frame
    finalFrameBlocks: b.get(i, e + 8),
    // the total number of frames
    totalFrames: b.get(i, e + 12),
    // the bits per sample (typically 16)
    bitsPerSample: R.get(i, e + 16),
    // the number of channels (1 or 2)
    channel: R.get(i, e + 18),
    // the sample rate (typically 44100)
    sampleRate: b.get(i, e + 20)
  })
}, C = {
  len: 32,
  get: (i, e) => ({
...
const D = $("music-metadata:parser:APEv2"), Ye = "APEv2", Ke = "APETAGEX";
class ne extends tr("APEv2") {
}
class M extends Tt {
  constructor() {
  ...
  static async findApeFooterOffset(e, t) {
    ...
    const a = C.get(r, 0);
    if (a.ID === "APETAGEX")
      return a.flags.isHeader ? D(`APE Header found at offset=${t - C.len}`) : (D(`APE Footer found at offset=${t - C.len}`), t -= a.size), { footer: a, offset: t };
  }
...
const Qr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  APEv2Parser: M,
  ApeContentError: ne
}, Symbol.toStringTag, { value: "Module" })), ie = $("music-metadata:parser:ID3v1"), Ze = [
  "Blues",
  "Classic Rock",
  "Country",
  "Dance",
...
const Je = $("music-metadata:parser");
async function sn(i, e = {}) {
  Je(`parseFile: ${i}`);
  const t = await Lt(i), r = new Yr();
  try {
...
function me(i) {
  return Ae(i.replace(/^local-file:/, "file:"));
}
function vt(i) {
  try {
    const e = new xe("utf-8", { fatal: !0 }).decode(i);
    if (!e.includes("�")) return e;
  } catch {
  }
  try {
    return new xe("gbk").decode(i);
  } catch {
  }
  return new xe("utf-8", { fatal: !1 }).decode(i);
}
function St(i, e) {
  const t = x.dirname(i), r = x.basename(i, x.extname(i)), n = x.join(t, `${r}${e}`);
  try {
    return w.existsSync(n) ? n : null;
  } catch (a) {
    return console.error(`findSidecarFile ${e} error:`, a), null;
  }
}
const X = (i) => St(i, ".lrc"), mn = (i) => St(i, ".cue");
...
function fn(i) {
  try {
    const t = vt(w.readFileSync(i)).split(/\r?\n/), r = [];
    let n = null, a = "", s = "", o = !1;
    for (const c of t) {
      const p = c.trim();
      if (!p) continue;
...
function pe(i) {
  try {
    const t = w.readdirSync(i, { withFileTypes: !0 }).filter((r) => r.isFile() && cn.has(x.extname(r.name).toLowerCase())).map((r) => ({ name: r.name, path: x.join(i, r.name) }));
    for (const r of ln) {
...
function fe(i) {
  const e = [];
  try {
    const t = w.readdirSync(i, { withFileTypes: !0 });
    for (const r of t) {
      const n = x.join(i, r.name);
      r.isDirectory() ? e.push(...fe(n)) : r.isFile() && on.has(x.extname(r.name).toLowerCase()) && e.push(n);
    }
  } catch (t) {
...
function dn(i) {
  const e = [];
  try {
    const r = w.readdirSync(i, { withFileTypes: !0 }).filter((n) => n.isDirectory()).map((n) => ({ name: n.name, fullPath: x.join(i, n.name) })).sort((n, a) => n.name.localeCompare(a.name, void 0, { numeric: !0 }));
    for (const { name: n, fullPath: a } of r) {
      const s = fe(a);
    ...
    console.error("scanArtistFolder error:", t);
  }
  return e;
}
const Ct = x.dirname(Ae(import.meta.url));
process.env.APP_ROOT = x.join(Ct, "../..");
const Ce = x.join(W.getPath("userData"), "config.json");
function de() {
  try {
    const i = w.readFileSync(Ce, "utf-8");
    return JSON.parse(i);
  } catch {
    return {};
  }
...
function hn(i) {
  try {
    w.mkdirSync(x.dirname(Ce), { recursive: !0 }), w.writeFileSync(Ce, JSON.stringify(i, null, 2));
  } catch (e) {
    console.error("saveConfig error:", e);
  }
}
const xn = x.join(process.env.APP_ROOT, "dist"), Qe = process.env.VITE_DEV_SERVER_URL;
let _ = null;
async function At() {
  _ = new ce({
    width: 900,
  ...
  }), Qe ? await _.loadURL(Qe) : await _.loadFile(x.join(xn, "index.html")), _.on("closed", () => {
    _ = null;
  });
}
A.handle("open-audio-file", async () => {
  const i = await q.showOpenDialog(_, {
    properties: ["openFile"],
    filters: [
  ...
  if (!i.canceled && i.filePaths.length > 0) {
    const e = i.filePaths[0], t = x.dirname(e), r = pe(t), n = X(e);
    return {
      url: I(e),
      coverUrl: r ? I(r) : null,
      lrcUrl: n ? I(n) : null
...
A.handle("open-lrc-file", async () => {
  const i = _ ?? ce.getFocusedWindow(), e = await q.showOpenDialog(i, {
    properties: ["openFile"],
    filters: [{ name: "LRC 歌词", extensions: ["lrc"] }]
  });
  return !e.canceled && e.filePaths.length > 0 ? I(e.filePaths[0]) : null;
});
A.handle("open-audio-folder", async () => {
  const i = await q.showOpenDialog(_, {
    properties: ["openDirectory"]
  });
  if (!i.canceled && i.filePaths.length > 0) {
    const e = i.filePaths[0], t = fe(e), r = pe(e), n = t.map((a) => {
      const s = X(a);
      return s ? I(s) : null;
    });
    return {
...
A.handle("open-artist-folder", async () => {
  const i = await q.showOpenDialog(_, {
    properties: ["openDirectory"],
    title: "选择歌手文件夹"
  });
  if (!i.canceled && i.filePaths.length > 0) {
    const e = i.filePaths[0], t = dn(e);
    return {
      artistName: x.basename(e),
      albums: t
    };
  }
  return null;
});
A.handle("get-cue-tracks", async (i, e) => {
  try {
    const t = me(e), r = mn(t);
    return r ? fn(r) : [];
  } catch (t) {
...
A.handle("get-audio-metadata", async (i, e) => {
  var t, r;
  try {
    const n = me(e);
    if (!w.existsSync(n)) return null;
...
A.handle("get-favorites-folder", async () => de().favoritesFolder || null);
A.handle("set-favorites-folder", async () => {
  const i = _ ?? ce.getFocusedWindow(), e = await q.showOpenDialog(i, {
    properties: ["openDirectory", "createDirectory"],
    title: "选择收藏文件夹"
  });
  if (!e.canceled && e.filePaths.length > 0) {
    const t = e.filePaths[0], r = de();
    return r.favoritesFolder = t, hn(r), t;
  }
  return null;
});
A.handle("add-to-favorites", async (i, e) => {
  const r = de().favoritesFolder;
  if (!r || !w.existsSync(r))
    return { ok: !1, error: "请先设置收藏文件夹" };
  try {
    const n = me(e);
    if (!w.existsSync(n)) return { ok: !1, error: "文件不存在" };
    ...
    if (c && w.existsSync(c)) {
      ...
      w.existsSync(m) || w.copyFileSync(c, m);
    }
    return { ok: !0, url: I(s) };
  } catch (n) {
...
A.handle("get-favorites-list", async () => {
  const e = de().favoritesFolder;
...
A.handle("remove-from-favorites", async (i, e) => {
  try {
    const t = me(e);
    if (w.existsSync(t)) {
      w.unlinkSync(t);
      const r = X(t);
      r && w.existsSync(r) && w.unlinkSync(r);
    }
    return { ok: !0 };
  } catch (t) {
...
W.whenReady().then(async () => {
  et.handle("local-file", async (i) => {
    const e = i.url.replace(/^local-file:/, "file:"), t = Ae(e), r = x.extname(t).toLowerCase();
    if (r === ".lrc")
      try {
        const s = w.readFileSync(t), o = vt(s);
