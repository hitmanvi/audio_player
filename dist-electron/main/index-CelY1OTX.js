...
const mpegParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MpegParser-DeLaGWZX.js")).MpegParser(metadata, tokenizer, options);
  }
};
...
const asfParserLoader = {
  ...
  extensions: [".asf"],
  async load(metadata, tokenizer, options) {
    return new (await import("./AsfParser-BbuTCyna.js")).AsfParser(metadata, tokenizer, options);
  }
};
const dsdiffParserLoader = {
  ...
  extensions: [".dff"],
  async load(metadata, tokenizer, options) {
    return new (await import("./DsdiffParser-EBM-3ZAn.js")).DsdiffParser(metadata, tokenizer, options);
  }
};
const aiffParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./AiffParser-CSRLWz_Z.js")).AIFFParser(metadata, tokenizer, options);
  }
};
const dsfParserLoader = {
  ...
  extensions: [".dsf"],
  async load(metadata, tokenizer, options) {
    return new (await import("./DsfParser-CNtAVKbf.js")).DsfParser(metadata, tokenizer, options);
  }
};
const flacParserLoader = {
  ...
  extensions: [".flac"],
  async load(metadata, tokenizer, options) {
    return new (await import("./FlacParser-BgrCJQAa.js")).FlacParser(metadata, tokenizer, options);
  }
};
const matroskaParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MatroskaParser-4nkvInUs.js")).MatroskaParser(metadata, tokenizer, options);
  }
};
const mp4ParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MP4Parser-F9AMKJxs.js")).MP4Parser(metadata, tokenizer, options);
  }
};
const musepackParserLoader = {
  ...
  extensions: [".mpc"],
  async load(metadata, tokenizer, options) {
    return new (await import("./MusepackParser-BhLEBFt6.js")).MusepackParser(metadata, tokenizer, options);
  }
};
const oggParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./OggParser-VKz6VP8F.js")).OggParser(metadata, tokenizer, options);
  }
};
const wavpackParserLoader = {
  ...
  extensions: [".wv", ".wvp"],
  async load(metadata, tokenizer, options) {
    return new (await import("./WavPackParser-_edrsImC.js")).WavPackParser(metadata, tokenizer, options);
  }
};
const riffParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./WaveParser-DphlpQS5.js")).WaveParser(metadata, tokenizer, options);
  }
};
