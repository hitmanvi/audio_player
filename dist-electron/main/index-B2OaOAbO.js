...
const mpegParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MpegParser-Bwhx338W.js")).MpegParser(metadata, tokenizer, options);
  }
};
...
const asfParserLoader = {
  ...
  extensions: [".asf"],
  async load(metadata, tokenizer, options) {
    return new (await import("./AsfParser-DwO8Rc_T.js")).AsfParser(metadata, tokenizer, options);
  }
};
const dsdiffParserLoader = {
  ...
  extensions: [".dff"],
  async load(metadata, tokenizer, options) {
    return new (await import("./DsdiffParser-CTZCuzc6.js")).DsdiffParser(metadata, tokenizer, options);
  }
};
const aiffParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./AiffParser-Bvba75T7.js")).AIFFParser(metadata, tokenizer, options);
  }
};
const dsfParserLoader = {
  ...
  extensions: [".dsf"],
  async load(metadata, tokenizer, options) {
    return new (await import("./DsfParser-CJp0FKWw.js")).DsfParser(metadata, tokenizer, options);
  }
};
const flacParserLoader = {
  ...
  extensions: [".flac"],
  async load(metadata, tokenizer, options) {
    return new (await import("./FlacParser-DnRASJRC.js")).FlacParser(metadata, tokenizer, options);
  }
};
const matroskaParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MatroskaParser-CgnTBNKe.js")).MatroskaParser(metadata, tokenizer, options);
  }
};
const mp4ParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MP4Parser-ClGs6s2L.js")).MP4Parser(metadata, tokenizer, options);
  }
};
const musepackParserLoader = {
  ...
  extensions: [".mpc"],
  async load(metadata, tokenizer, options) {
    return new (await import("./MusepackParser-CshczD67.js")).MusepackParser(metadata, tokenizer, options);
  }
};
const oggParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./OggParser-CkPRF1RJ.js")).OggParser(metadata, tokenizer, options);
  }
};
const wavpackParserLoader = {
  ...
  extensions: [".wv", ".wvp"],
  async load(metadata, tokenizer, options) {
    return new (await import("./WavPackParser-BXeoPgsV.js")).WavPackParser(metadata, tokenizer, options);
  }
};
const riffParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./WaveParser-BmgjjGDZ.js")).WaveParser(metadata, tokenizer, options);
  }
};
