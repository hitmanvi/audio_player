import { f as l, c as D, k as I, F as u, B as f, J as z, N as S, b as k, u as B, m as w, d as x } from "./index-BDmZwDXc.js";
const P = [
  6e3,
  8e3,
  9600,
...
const o = x("music-metadata:parser:WavPack");
class g extends w("WavPack") {
}
class F extends f {
  constructor() {
  ...
  async parse() {
    return this.audioDataSize = 0, await this.parseWavPackBlocks(), z.tryParseApeHeader(this.metadata, this.tokenizer, this.options);
  }
