import { n as f, F as s, B as z, c as w, o as I, f as S, a as c, b as u, U as p, S as D, m as b, d as g } from "./index-BVgRrzRX.js";
import "node:fs/promises";
import { I as C } from "./ID3v2Parser-CyvM6V7T.js";
const o = {
  len: 12,
  get: (h, t) => ({
    // Group-ID
...
}, a = g("music-metadata:parser:aiff");
class d extends b("DSDIFF") {
}
class y extends z {
  async parse() {
  ...
  async readData(t) {
    ...
    switch (t.chunkID.trim()) {
      ...
      case "ID3": {
        const r = await this.tokenizer.readToken(new w(Number(t.chunkSize))), n = I(r);
  ...
  async handleSoundPropertyChunks(t) {
    for (a(`Parsing sound-property-chunks, remainingSize=${t}`); t > 0; ) {
      ...
      switch (e.chunkID.trim()) {
        ...
        case "CMPR": {
          const n = (await this.tokenizer.readToken(s)).trim(), k = await this.tokenizer.readToken(u), m = await this.tokenizer.readToken(new D(k, "ascii"));
