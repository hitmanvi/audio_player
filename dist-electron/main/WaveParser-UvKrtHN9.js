...
import { f as o, S as h, m as w, k as s, c as S, s as c, B as I, E as p, F as m, o as z, d as T } from "./index-BVgRrzRX.js";
import { I as f } from "./ID3v2Parser-CyvM6V7T.js";
const k = {
  len: 8,
  get: (t, e) => ({
    // Group-ID
...
}, r = T("music-metadata:parser:RIFF");
class F extends I {
  constructor() {
  ...
  async readWaveChunk(e) {
    for (; e >= k.len; ) {
      ...
      switch (e -= k.len + a.chunkSize, a.chunkSize > e && this.metadata.addWarning("Data chunk size exceeds file size"), this.header = a, r(`pos=${this.tokenizer.position}, readChunk: chunkID=RIFF/WAVE/${a.chunkID}`), a.chunkID) {
        ...
        case "id3 ":
        case "ID3 ": {
          const i = await this.tokenizer.readToken(new S(a.chunkSize)), n = z(i);
